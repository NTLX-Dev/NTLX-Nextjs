...
const Team = () => {        
    return (
        <section className="py-12 bg-white sm:py-16 lg:pt-0 lg:pb-10">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl font-pj">Our{" "}<span className='text-red-600'>Investors</span>{" "}& Board of{" "}<span className='text-red-600'>Directors</span></h2>
        </div>
        ...
        <div className="grid max-w-6xl grid-cols-1 px-20 mx-auto mt-12 text-center sm:px-0 sm:grid-cols-2 md:mt-20 gap-x-8 md:grid-cols-4 gap-y-12 lg:gap-x-16 xl:gap-x-20">
            <div>
                <img className="object-cover w-32 h-32 mx-auto rounded-full lg:w-44 lg:h-44 grayscale filter" src="https://raw.githubusercontent.com/NTLX-Dev/NTLX-Nextjs/refs/heads/main/public/kanikaNexoraTLX.jpg" alt="" />
                <p className="mt-5 text-lg font-bold text-gray-900 sm:text-xl sm:mt-8 font-pj">Kanika Agarwal</p>
                <p className="mt-2 text-base font-normal text-gray-600 font-pj">Founder, Chairman, Executive Director</p>
            </div>
            {/*
            <div>
        ...
        {/* <div className="max-w-3xl mx-auto mt-12 space-y-8 sm:space-y-0 sm:flex sm:items-center sm:justify-center sm:mt-16 sm:gap-x-16">
            ...
            <div>
                <img className="w-auto mx-auto h-11" src="/brands/Coursera.svg" alt="" />
            </div>
